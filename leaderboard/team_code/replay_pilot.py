...
class ReplayPilot(MapAgent):
    def setup(self, path_to_conf_file, path_to_replay_file):
    ...
    # TODO this function needs to read the replay from the replay file itself
    def run_step(self, input_data, timestamp):
        if not self.initialized:
            self._init()

        # every hundred 100 steps reset weather for "data augmentation"
        if self.step % 100 == 0:
        ...
        # these 3 look like the waypoints are being drawn onto images
